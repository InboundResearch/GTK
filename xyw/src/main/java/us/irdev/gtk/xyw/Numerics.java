...
public class Numerics {
  ...
  public static final int BITS_OF_PRECISION = (int) -(Math.log (TOLERANCE) / Math.log (2));
   ...
   */
  public static boolean similar (double a, double b, double enough) {
    return (a == b) || (abs (a - b) <= ((abs (a) + abs (b) + Math.pow(10, enough)) * TOLERANCE));
  }
   ...
   */
  public static final double A_LITTLE_BIT = 0.0;
  ...
  public static boolean similar (double a, double b) {
    return similar (a, b, A_LITTLE_BIT);
  }
}
